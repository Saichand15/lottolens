...
export default function MMBallMatrixPage() {
  ...
  if (loading) return <div className="loading-screen"><div className="loading-spinner" /><p className="loading-text">Loading Mega Ball (1–25) matrix…</p></div>
  ...
  return (
    <div className="matrix-page">
      <div className="matrix-info-bar">
        {lastDraw && (
          <div className="hdr-last">
            <span className="hdr-last-label">LATEST MB</span>
            <span className="hdr-ball" style={{ background: '#f59e0b' }}>{lastDraw[0]}</span>
          </div>
        )}
      ...
      <footer className="matrix-footer">
        ...
        <div className="legend-item" style={{ color: '#f59e0b', fontWeight: 700 }}>🟡 Mega Ball Matrix (1–25)</div>
      </footer>
    </div>
  )
}
